...
model_str = 'resnet18' # ['resnet18', ...] (TODO)
expid = '00'
epochs = 1 # can set to 5
batch_size = 128
...
model = eval('models.' + model_str + '()')  # example: models.resnet18()
...
optimizer = torch.optim.Adam(model.parameters(), lr=lr)  # Adam optimizer for momentum-rms balance
